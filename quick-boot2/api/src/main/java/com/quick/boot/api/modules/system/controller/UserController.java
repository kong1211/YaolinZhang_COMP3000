...
public class UserController {
    ...
    public Restful<Page<User>> getUserList(PageQuery query) {
        ...
        logService.addLog((String) SecurityUtils.getSubject().getPrincipal(), "View用户列表");
    ...
    public Restful<Void> delUser(@PathVariable Integer id) {
        ...
        logService.addLog((String) SecurityUtils.getSubject().getPrincipal(), "delete用户信息 ID=>" + id);
        return Restful.ok(null);
    }
