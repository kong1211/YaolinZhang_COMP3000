...
public class PermissionController {
    ...
    public R<Page<Permission>> permissionList(PageQuery query) {
        logService.addLog((String) SecurityUtils.getSubject().getPrincipal(), "View权限列表");
    ...
    public R<Void> deletePermission(@PathVariable Integer id) {
        logService.addLog((String) SecurityUtils.getSubject().getPrincipal(), "delete权限信息 ID=>" + id);
